...
export class ManageMetadata extends ModalAction {
  ...
  checkCustomMetadataEmpty = (values = []) => {
  ...
  checkCustomMetadataDuplicate = (values = []) => {
  ...
  checkCustomMetadataAlreadyExist = (values = []) => {
    const existingKeys = this.getExistingMetadataKeys();
  ...
  get formItems() {
    return [
      ...
      },
      {
        ...
        itemComponent: KeyValueInput,
        validator: (_, value) => {
          if (!this.checkCustomMetadataEmpty(value)) {
            return Promise.reject(t('Please input key and value'));
          }
          if (!this.checkCustomMetadataDuplicate(value)) {
            return Promise.reject(t('Metadata key must be unique'));
          }
          if (!this.checkCustomMetadataAlreadyExist(value)) {
